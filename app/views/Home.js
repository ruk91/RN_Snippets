  ...
  constructor(props) {
    ...
    this.state = {
      ...
      data: [
        ...
        {id:1,  name: "Profile",   image:"https://img.icons8.com/clouds/100/000000/groups.png",           count:124.711},
        {id:2,  name: "ProfileCardView",    image:"https://img.icons8.com/color/100/000000/real-estate.png",       count:234.722},
        {id:2,  name: "CompanyDescriptionView",    image:"https://img.icons8.com/color/100/000000/real-estate.png",       count:234.722},
        {id:3,  name: "ContactView",       image:"https://img.icons8.com/color/100/000000/find-matching-job.png", count:324.723} ,
        {id:4,  name: "ModalDetail",   image:"https://img.icons8.com/clouds/100/000000/employee-card.png",    count:154.573} ,
        {id:5,  name: "WhatsappCall",   image:"https://img.icons8.com/color/100/000000/land-sales.png",        count:124.678} ,
      ]
    };
